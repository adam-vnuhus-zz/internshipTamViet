<div id="header">
			<div class="center">
				...
				<div class="right">
					<button class="topright bottom_radius text14 opensans" onclick="drop_downFn1();">
					...
					<button class="topright bottom_radius text14 opensans" onclick="drop_downFn2();">
		...
		<div id="header1">
			<div id="logo" class="center clearfix">
				...
				<div class="right" style="width: 55.53%;">
					...
					%"> -->
					<button class="cart_dd_btn right white text24" onclick="drop_downFn3();">
						<i class="fas fa-shopping-cart"></i>
						<p class="number text12 white opensans">03</p>
						<div id="quick_cart" class="cart_dd" >
					...
					<button class="cart_dd_btn right white text24" onclick="drop_downFn4()";>
						<i class="fas fa-edit"></i>
						<p class="number text12 white opensans">02</p>
						<div id="wish_list" class="cart_dd">
							<p class="title_dd text12 opensans grey">
								Showing 2 of 2 items added
							</p>
							<div class="list_dd clearfix">
					...
					<a href="#"><p class="green text14 right opensans">CREATE ACCOUNT</p></a>
			...
			<div id="menu" class="clearfix">
				<div class="center">
					<div id="menu1">
						...
						<a href="grid.php" class="opensans left green text14
						">DESKTOP</a>
					...
					<div id="search" class="right">
						...
						<a href="#" class="left">
							<img src="img/search.png" height="34px">
						</a>
					</div>
