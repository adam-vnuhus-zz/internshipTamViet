...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 25, 2018 lúc 12:04 PM
...
CREATE TABLE `binhluan` (
  `id_bl` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID binh luan',
  `id_sp` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID san pham',
  `id_nd` varchar(15) CHARACTER SET utf8 NOT NULL,
  `Ho_ten` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Ho ten ngoi binh luan',
  `Ngay_gio` datetime NOT NULL COMMENT 'Thoi diem binh luan',
  `Noi_dung` varchar(250) CHARACTER SET utf8 NOT NULL COMMENT 'Noi dung binh luan',
  `Dien_thoai` varchar(25) CHARACTER SET utf8 NOT NULL COMMENT 'So dien thoai nguoi binh luan'
...
CREATE TABLE `ct_hd` (
  `id_ct_hd` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID chi tiet hoa don',
  `id_hd` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID cua hoa don',
  `id_sp` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT 'ID cua san pham',
  `So_luong_mua` int(5) NOT NULL COMMENT 'So san pham trong hoa don',
  `Don_gia` double(15,3) NOT NULL COMMENT 'Don gia cua hoa don'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `danhmuc_sp` (
  `id_danhmuc` varchar(3) CHARACTER SET utf8 NOT NULL COMMENT 'ID danh muc',
  `Ten_dm` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Ten danh muc'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `don_dh` (
  `id_hd` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID hoa don',
  `id_ct_hd` varchar(15) CHARACTER SET utf8 NOT NULL,
  `id_kh` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID khach hang',
  `id_tinhtrang` int(2) NOT NULL COMMENT 'ID tinh trang don hang',
  `id_nvgh` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID nhan vien giao hang',
  `Ngay_lap` datetime NOT NULL COMMENT 'Ngay lap hoa don',
  `Tong_gia` double(15,3) NOT NULL COMMENT 'Tong gia cua hoa don',
  `Noi_nhan` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Noi nhan don hang',
  `Ghi_chu` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Ghi chu cua nhan vien'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `khachhang` (
  `id_kh` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'ID khach hang',
  `Ten_kh` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Ten khach hang',
  `Sdt` varchar(50) NOT NULL COMMENT 'So dien thoai khach hang',
  `Mail` varchar(50) NOT NULL COMMENT 'Email khach hang',
  `Diachi_kh` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Dia chi khach hang'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `nguoidung` (
  `id_nd` varchar(15) NOT NULL COMMENT 'ID nguoi dung',
  `Ten_nd` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'Ten nguoi dung',
...
CREATE TABLE `sanpham` (
  ...
  `id_khuyenmai` varchar(10) NOT NULL COMMENT 'ID khuyen mai',
  `id_dm` varchar(3) NOT NULL COMMENT 'ID danh muc',
  `Ten_sp` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Ten san pham',
  ...
  `Bao_hanh` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'Bao hanh',
...
--
-- Cấu trúc bảng cho bảng `sanpham_ctdh`
--

CREATE TABLE `sanpham_ctdh` (
  `id_ctdh` varchar(15) NOT NULL,
...
CREATE TABLE `sp_ban` (
  `id_sp_ban` varchar(15) NOT NULL COMMENT 'ID san pham ban',
  `id_sp` varchar(15) NOT NULL COMMENT 'ID san pham',
...
CREATE TABLE `tinh_trang` (
  ...
  `Tinh_trang` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT 'Tinh trang cua san pham'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Chỉ mục cho bảng `sanpham_ctdh`
--
ALTER TABLE `sanpham_ctdh`
  ADD PRIMARY KEY (`id_ctdh`,`id_sp`);
